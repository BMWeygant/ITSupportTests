...
category: "Networking",
topic: "Name Resolution")
Question.create(query: "An A Record contains what?",
correct_answer: "An IPv4 address",
answer: "",
choice1: "A CNAME",
choice2: "An IPv4 address,",
choice3: "An IPv6 address.",
choice4: "A fully qualified domain name.", 
category: "Networking",
topic: "Name Resolution")
Question.create(query: "MX stands for _______.",
correct_answer: "Mail exchange",
answer: "",
choice1: "Micro extreme",
choice2: "Micro exchange",
choice3: "Mail exchange",
choice4: "Meta exchange", 
category: "Networking",
topic: "Name Resolution")
Question.create(query: "A fully qualified domain name can contain how many characters?",
correct_answer: "255",
answer: "",
choice1: "63",
choice2: "64",
...
category: "Networking",
topic: "Name Resolution")
Question.create(query: "When using Fixed Allocation DHCP, what's used to determine a computer's IP?",
correct_answer: "A MAC address",
answer: "",
choice1: "A subnet mask",
choice2: "A MAC address",
choice3: "Location",
choice4: "A Record", 
category: "Networking",
topic: "Dynamic Host Configuration Protocol")
Question.create(query: "The process by which a client configured to use DHCP attempts to get network configuration information is known as _________________.",
correct_answer: "DHCP Discovery",
answer: "",
choice1: "DHCP Discovery",
choice2: "DHCP Request",
choice3: "DHCP Request",
choice4: "DHCP Offer", 
category: "Networking",
topic: "Dynamic Host Configuration Protocol")
Question.create(query: "What are the four things that all computers need configured in order to operate on a modern network?",
correct_answer: "An IP address, A name server, A subnet mask, A default gateway",
answer: "",
choice1: "An IP address, A TCP port, A default gateway, A MAC address",
choice2: "An IP address, A name server, A TCP port, An NTP server",
choice3: "An IP address, A name server, A subnet mask, A default gateway",
choice4: "An IP address, A subnet mask, A default gateway, A MAC address", 
category: "Networking",
topic: "Dynamic Host Configuration Protocol")
Question.create(query: "NAT addresses concerns over the dwindling IPv4 address space by ___________________.",
correct_answer: "allowing computers using non-routable address space to communicate with the Internet.",
answer: "",
choice1: "allowing networks to use fewer IP addresses overall.",
choice2: "allowing users to move to IPv6 when they want.",
choice3: "allowing computers using non-routable address space to communicate with the Internet.",
choice4: "performing IP masquerading.", 
category: "Networking",
topic: "Network Address Translation")
Question.create(query: "What technique allows for inbound traffic through a NAT?",
correct_answer: "Port forwarding",
answer: "",
choice1: "Port preservation",
choice2: "Port forwarding",
choice3: "Port authority",
choice4: "Ephemeral ports", 
category: "Networking",
topic: "Network Address Translation")
Question.create(query: "The total number of IPv4 addresses is approximately:",
correct_answer: "4.2 billion",
answer: "",
choice1: "4.2 million",
choice2: "4.2 billion",
choice3: "4.2 trillion",
choice4: "Uncountable", 
category: "Networking",
topic: "Network Address Translation")
Question.create(query: "Two-factor authentication is_________________________.",
correct_answer: "a method where you need more than a username and a password.",
answer: "",
choice1: "a method where you need more than a username and a password.",
choice2: "a method where you authenticate twice.",
choice3: "a method that requires two usernames.",
choice4: "a method where you need two passwords.", 
category: "Networking",
topic: "VPNs & Proxies")
Question.create(query: "A proxy is something that _______________________.",
correct_answer: "communicates on behalf of something else.",
answer: "",
choice1: "communicates on behalf of something else.",
choice2: "sends data across a single network segment.",
choice3: "allows for many devices to speak to one other device.",
choice4: "encrypts traffic sent across the Internet.", 
category: "Networking",
topic: "VPNs & Proxies")
Question.create(query: "VPNs are known as a _____ protocol.",
correct_answer: "tunneling",
answer: "",
choice1: "connectionless",
choice2: "tunneling",
...
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "NAT stands for ____.",
correct_answer: "Network Address Translation",
answer: "",
choice1: "National Academic Translation",
choice2: "Networking Association Team",
choice3: "Network Address Translation",
choice4: "Network Acknowledgement Track", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "VPN stands for _______.",
correct_answer: "Virtual Private Network",
answer: "",
choice1: "Very Personal Network",
choice2: "Virtual Private Network",
choice3: "Virtual Public Network",
choice4: "Virtual Proxy Network", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "Which type of Domain Name System (DNS) server performs a full name resolution request?",
correct_answer: "Recursive name server",
answer: "",
choice1: "Caching name server",
choice2: "Root name server",
choice3: "Recursive name server",
choice4: "Authoritative name server", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "A video conferencing application isn't working due to a Domain Name System (DNS) port error. Which record requires modification to fix the issue?",
correct_answer: "Service record (SRV)",
answer: "",
choice1: "Text (TXT)",
choice2: "Host (A)",
choice3: "Service record (SRV)",
choice4: "Canonical name (CNAME)", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "Which of the following allows computers on a network to automatically receive address assignment information?",
correct_answer: "Dynamic Host Protocol (DHCP)",
answer: "",
choice1: "Domain Name System (DNS)",
choice2: "Time to Live (TTL)",
choice3: "Dynamic Host Protocol (DHCP)",
choice4: "Primary gateway", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "Network Address Translation (NAT) is typically implemented with which hardware devices? Check all that apply.",
correct_answer: ["Firewalls", "Routers"],
answer: "",
choice1: "Hubs",
choice2: "Firewalls",
choice3: "Routers",
...
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "Which technology uses a tunneling protocol?",
correct_answer: "Virtual Private Network (VPN)",
answer: "",
choice1: "Dynamic Host Configuration Protocol (DHCP)",
choice2: "Domain Name System (DNS)",
choice3: "Virtual Private Network (VPN)",
choice4: "Network Address Translation (NAT)", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "What benefits does the Domain Name System (DNS) provide? Check all that apply.",
correct_answer: ["Easy mapping to a new Internet Protocol (IP) address", "Ease of address memorization"],
answer: "",
choice1: "Easy mapping to a new Internet Protocol (IP) address",
choice2: "Assigning Internet Protocol (IP) addresses",
choice3: "Ease of address memorization",
choice4: "Network Address Translation (NAT)", 
category: "Networking",
topic: "Networking Services Quiz")


Question.create(query: "A complete Fully Qualified Domain Name (FQDN) is limited to how many characters?",
correct_answer: "255",
answer: "",
choice1: "127",
choice2: "63",
...
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "An internal system behind a firewall needs to be configured for remote access. How should Network Address Translation be configured?",
correct_answer: "Port forwarding",
answer: "",
choice1: "Port forwarding",
choice2: "Preservation",
choice3: "Rewriting",
choice4: "One-to-many NAT", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "What term defines keeping the address of one computer secret from another?",
correct_answer: "Masquerading",
answer: "",
choice1: "Masquerading",
choice2: "Preservation",
choice3: "Translation",
choice4: "Rewriting", 
category: "Networking",
...
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "The Domain Name System (DNS) provides an easy way to remember addresses. Without DNS, how many octets for an Internet Protocol (IP) address would have to be memorized?",
correct_answer: "4",
answer: "",
choice1: "48",
choice2: "10101010",
...
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "During the name resolution process, which technique is used to avoid congestion when querying a server?",
...
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "There are 13 _____ name servers.",
correct_answer: "root",
answer: "",
choice1: "root",
choice2: "recursive",
choice3: "authoritative",
choice4: "TLD", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "At the very lowest level, what data does a computer understand?",
correct_answer: "Binary numbers",
answer: "",
choice1: "IP (Internet Protocol) addresses",
choice2: "Media Access Control (MAC) addresses",
choice3: "Hexadecimal digits",
choice4: "Binary numbers", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "The Domain Name System (DNS) network service uses which transport layer protocol?",
correct_answer: "User Datagram Protocol (UDP)",
answer: "",
choice1: "Transmission Control Protocol (TCP)",
choice2: "IP (Internet Protocol)",
choice3: "User Datagram Protocol (UDP)",
choice4: "Hypertext Transfer Protocol (HTTP)", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "The Dynamic Configuration Host Protocol (DHCP) operates at which Open Systems Interconnection (OSI) model layer?",
...
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "Which technique is used with Network Address Translation (NAT) where a source port chosen by a client is the same port used by a router?",
correct_answer: "Preservation",
answer: "",
choice1: "Forwarding",
choice2: "Preservation",
choice3: "Translation",
choice4: "Masquerading", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "What port on a name server is used for User Datagram Protocol (UDP) name request packets?",
correct_answer: "53",
answer: "",
choice1: "22",
choice2: "53",
...
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "IANA has primarily been responsible with assigning address blocks to five regional internet registries (RIR). A tech needs to research address blocks assigned in the United States. Which RIR should the tech contact?",
correct_answer: "ARIN",
answer: "",
choice1: "ARIN",
choice2: "RIPE",
...
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "What service acts on behalf of a client in order to access another service?",
correct_answer: "Proxy Server",
answer: "",
choice1: "Domain Name System (DNS)",
choice2: "Virtual Private Network (VPN) Tunnel",
choice3: "Dynamic Host Configuration Protocol (DHCP)",
choice4: "Proxy Server", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "A technique that’s used to route traffic to different destinations, depending on factors like location, congestion, or link health, is known as _____.",
correct_answer: "anycast",
answer: "",
choice1: "unicast",
choice2: "anycast",
...
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "A _______ record is responsible for resolving an IP to a domain name.",
correct_answer: "",
answer: "",
choice1: "CNAME",
choice2: "PTR",
...
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "When a range of IP addresses is set aside for client devices, and one of these IPs is issued to these devices when they request one, this is known as _______ allocation.",
...
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "When NAT hides the source IP of an originating device, this is known as ________.",
correct_answer: "IP masquerading",
answer: "",
choice1: "port forwarding",
choice2: "routing",
choice3: "switching",
choice4: "IP masquerading", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "The 'www' portion of a domain is known by which of the given options? Check all that apply.",
correct_answer: ["Host name", "Subdomain"],
answer: "",
choice1: "Host name",
choice2: "Fully Qualified Domain Name (FQDN)",
choice3: "Top Level Domain (TLD) name",
choice4: "Subdomain", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "An IT systems engineer creates a new Domain Name System (DNS) zone that contains pointer (PTR) resource records. Which zone type has been created?",
correct_answer: "Reverse lookup",
answer: "",
choice1: "Reverse lookup",
choice2: "Start of Authority (SOA)",
choice3: "Fully Qualified Domain Name (FQDN)",
choice4: "Subdomain", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "Network Address Translation (NAT) technology provides a major benefit for which of these network problems?",
correct_answer: "Address exhaustion",
answer: "",
choice1: "Routable addresses",
choice2: "Address exhaustion",
choice3: "Assigning Internet Protocol (IP) address blocks",
choice4: "Port Preservation", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "An IT engineer is planning a website upgrade with load balancing features. What technology is used?",
correct_answer: "Reverse proxy",
answer: "",
choice1: "Port forwarding",
choice2: "Reverse proxy",
choice3: "Web proxy",
choice4: "Round robin", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "A company with a large number of hosts creates three subdomains under a main domain. For easier management of the host records, how many zones should be used?",
correct_answer: "4",
answer: "",
choice1: "4",
choice2: "3",
...
Question.create(query: "Which allocation method can be used with a Dynamic Host Configuration (DHCP) server to assign the same address to the same machine if possible?",
...
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "When a client computer sends a request to a Domain Name System (DNS) server, what type of packet is sent?",
correct_answer: "SYN",
answer: "",
choice1: "TCP",
choice2: "ACk",
...
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "A concept that involves iterating over a list of items one by one in an orderly fashion is known as ___",
correct_answer: "round robin",
answer: "",
choice1: "round robin",
choice2: "recursion",
choice3: "authoritative lookup",
choice4: "multiplexing", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "Along with an IP address, a subnet mask, and a name server, the other thing required for a computer to operate on a network is a _______.",
...
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "A service that might appear to be a single server to external clients, but actually represents many servers living behind it, is known as a _______.",
correct_answer: "reverse proxy",
answer: "",
choice1: "VPN",
choice2: "multiplexer",
choice3: "reverse proxy",
choice4: "proxy", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "A new Domain Name System (DNS) server is being configured. Which record type is used to declare a new zone?",
correct_answer: "Start of Authority (SOA)",
answer: "",
choice1: "Mail Exchanger (MX)",
choice2: "Start of Authority (SOA)",
choice3: "Name server (NS)",
choice4: "Pointer (PTR)", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "Which of the following is NOT configured by a Dynamic Host Protocol (DHCP) server?",
correct_answer: "Media Access Control (MAC) address",
answer: "",
choice1: "Gateway Address",
choice2: "Subnet mask address",
choice3: "Internet Protocol (IP) Address",
choice4: "Media Access Control (MAC) address", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "Which of the following allows computers on a network to automatically receive address assignment information?",
...
answer: "",
choice1: "Domain Name System (DNS)",
choice2: "Primary gateway",
choice3: "Dynamic Host Protocol (DHCP)",
choice4: "Time to Live (TTL)", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "A company moves a popular website to a new web host. Which of the following will change as a result?",
correct_answer: "Internet Protocol (IP) address",
answer: "",
choice1: "Internet Protocol (IP) address",
choice2: "Network service",
choice3: "Root name server",
choice4: "Domain name", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "What is the importance of using DNS?",
correct_answer: "Name resolution",
answer: "",
choice1: "Get connected",
choice2: "Assigning addresses",
choice3: "Securing a network",
choice4: "Name resolution", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "",
correct_answer: "",
...
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "What technology helps users get connected and stay secure?",
correct_answer: "Virtual Private Network (VPN)",
answer: "",
choice1: "Dynamic Host Configuration Protocol (DHCP)",
choice2: "Network Address Translation (NAT)",
choice3: "Domain Name System (DNS)",
choice4: "Virtual Private Network (VPN)", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "During the name resolution process, which server does a local recursive server contact first?",
correct_answer: "Root name server",
answer: "",
choice1: "Caching name server",
choice2: "Root name server",
choice3: "Authoritative name server",
choice4: "Top level domain (TLD) server", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "A Virtual Private Network (VPN) uses a particular layer from the OSI reference model to carry an encrypted payload that actually contains an entire second set of packets. Which layer is used?",
correct_answer: "Transport",
answer: "",
choice1: "Application",
choice2: "Network",
choice3: "Transport",
choice4: "Presentation", 
category: "Networking",
topic: "Networking Services Quiz")
Question.create(query: "",
correct_answer: "",
